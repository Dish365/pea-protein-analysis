...
class OperationalExpenditureAnalysis:
    ...
    def calculate_total_opex(self, maintenance_factor: float = 0.05) -> Dict[str, float]:
        ...
        maintenance_costs = calculate_maintenance_costs(self.equipment_costs, maintenance_factor)
