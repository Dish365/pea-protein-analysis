...
# Load Rust library
lib_path = Path(__file__).parent.parent.parent.parent / "backend/rust_modules/target/release/libprotein_analysis.so"
...
class TechnicalIntegrator:
    def __init__(self):
        ...
        self.lib = lib
        self.lib.calculate_protein_recovery.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double]
