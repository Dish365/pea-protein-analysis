...
class ProteinRecoveryCalculator:
   ...
   Calculate and analyze protein recovery metrics in fractionation processes.
    ...
    def estimate_yield(
        self,
        target_protein_content: float,
        efficiency_factor: Optional[float] = 0.95
    ) -> Dict[str, float]:
        """
        ...
        theoretical_yield = (self.initial_protein_content / target_protein_content) * 100
