...
export function ProteinRecoveryChart() {
  ...
  if (isLoading) return <div className="h-[300px] animate-pulse bg-gray-100 rounded-lg" />;
  if (error) return <div className="text-red-500">Error loading protein recovery data</div>;
