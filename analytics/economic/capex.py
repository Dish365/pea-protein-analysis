...
class CapitalExpenditureAnalysis:
    ...
    def calculate_total_capex(self, installation_factor: float = 0.2, indirect_costs_factor: float = 0.15) -> Dict[str, float]:
        ...
        installation_costs = calculate_installation_costs(equipment_costs, installation_factor, indirect_costs_factor)
