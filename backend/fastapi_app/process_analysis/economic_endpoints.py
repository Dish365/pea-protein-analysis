...
from analytics.economic.services.cost_estimation import estimate_total_investment, estimate_annual_costs
from analytics.economic.services.cost_tracking import CostTracker
from analytics.economic.profitability.mcsp import calculate_mcsp, perform_sensitivity_analysis
...
async def analyze_profitability(input_data: EconomicAnalysisInput):
    ...
    try:
        ...
        payback = calculate_payback_period(sum(input_data.capex.values()), input_data.cash_flows)
